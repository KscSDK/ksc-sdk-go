...
const KSC_SDKImportRoot = "github.com/ksc/ksc-sdk-go"
...
// KscAddSDKImport adds a SDK package import to the generated file's import.
func (a *API) KscAddSDKImport(v ...string) error {
	e := make([]string, 0, 5)
	e = append(e, KSC_SDKImportRoot)
	e = append(e, v...)
...
func ExtraNew(info *utils.UrlInfo,p client.ConfigProvider, cfgs ...*aws.Config) *{{ .StructName }} {
	{{ if .Metadata.NoResolveEndpoint -}}
		var c client.Config
		if v, ok := p.(client.ConfigNoResolveEndpointProvider); ok {
			c = v.ClientConfigNoResolveEndpoint(cfgs...)
