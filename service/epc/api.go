...
//    }
//
// See also, https://docs.aws.amazon.com/goto/WebAPI/epc-2015-11-01/DescribeCertificates
func (c *Epc) DescribeCertificatesRequest(input *map[string]interface{}) (req *request.Request, output *map[string]interface{}) {
	op := &request.Operation{
...
// DescribeCertificates API operation for epc.
//
// Returns awserr.Error for service API and SDK errors. Use runtime type assertions
// with awserr.Error's Code and Message methods to get detailed information about
// the error.
...
// See also, https://docs.aws.amazon.com/goto/WebAPI/epc-2015-11-01/DescribeCertificates
func (c *Epc) DescribeCertificates(input *map[string]interface{}) (*map[string]interface{}, error) {
...
// sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *Epc) DescribeCertificatesWithContext(ctx aws.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeCertificatesRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
