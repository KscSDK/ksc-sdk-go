...
// Package cdn1iface provides an interface to enable mocking the cdn1 service client
...
// Cdn1API provides an interface to enable mocking the
// cdn1.Cdn1 service client's API operation,
...
//    // cdn1.
//    func myFunc(svc cdn1iface.Cdn1API) bool {
...
//    type mockCdn1Client struct {
//        cdn1iface.Cdn1API
//    }
//    func (m *mockCdn1Client) AddCdnDomainGet(input *map[string]interface{}) (*map[string]interface{}, error) {
//        // mock response/functionality
//    }
//
//    func TestMyFunc(t *testing.T) {
//        // Setup Test
//        mockSvc := &mockCdn1Client{}
//
//        myfunc(mockSvc)
//
